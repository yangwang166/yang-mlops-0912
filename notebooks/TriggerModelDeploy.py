...
#                            (https://docs.microsoft.com/azure/databricks/dev-tools/databricks-utils#get-command-dbutilsjobstaskvaluesget),
...
github_repo = dbutils.secrets.get(
    f"{env}-yang-mlops-project-0912-cd-credentials", "github_repo"
)
token = dbutils.secrets.get(
    f"{env}-yang-mlops-project-0912-cd-credentials", "token"
)
