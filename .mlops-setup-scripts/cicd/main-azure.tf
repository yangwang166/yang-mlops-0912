resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "yang-mlops-project-0912-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "yang-mlops-project-0912-cicd"
  project_directory_path       = "/yang-mlops-project-0912"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "yang-mlops-project-0912-service-principals"
}
