...
Opening a pull request will trigger both unit tests and integration tests that run the
...
jobs in staging and production will use automatically use your updated ML code.

You can track the state of the ML pipelines for the current project from the MLflow registered model UI. Links:
* [Staging workspace registered model](https://adb-8405830731420074.14.azuredatabricks.net#mlflow/models/staging-yang-mlops-project-0912-model)
* [Prod workspace registered model](https://adb-1005182519515014.14.azuredatabricks.net#mlflow/models/prod-yang-mlops-project-0912-model)
